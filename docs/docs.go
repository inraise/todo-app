...
const docTemplate = `{
        ...
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Фильтрация статистики по пользователю",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Начало промежутка для статистики (включительно)",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Конец промежутка для статистики (не включительно)",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_inraise_todo-app_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_inraise_todo-app_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "github_com_inraise_todo-app_internal_core_transport_http_types.Nullable-bool": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "github_com_inraise_todo-app_internal_core_transport_http_types.Nullable-string": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "internal_features_tasks_transport_http.PatchTaskRequest": {
            ...
            "properties": {
                "completed": {
                    "$ref": "#/definitions/github_com_inraise_todo-app_internal_core_transport_http_types.Nullable-bool"
                },
                "description": {
                    "$ref": "#/definitions/github_com_inraise_todo-app_internal_core_transport_http_types.Nullable-string"
                },
                "title": {
                    "$ref": "#/definitions/github_com_inraise_todo-app_internal_core_transport_http_types.Nullable-string"
                }
